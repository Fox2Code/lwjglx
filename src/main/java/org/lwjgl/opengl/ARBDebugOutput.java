...
public class ARBDebugOutput {
    ...
    public static void glDebugMessageCallbackARB(ARBDebugOutputCallback callback) {
        glDebugMessageCallbackARB(callback.lwjglxGetLWJGL3Callback(), NULL);
    }
    // -- End LWJGL2 part --
    ...
    public static void glDebugMessageControlARB(@NativeType("GLenum") int source, @NativeType("GLenum") int type, @NativeType("GLenum") int severity, @NativeType("GLuint const *") @Nullable int [] ids, @NativeType("GLboolean") boolean enabled) {
    ...
    @NativeType("GLuint")
    public static int glGetDebugMessageLogARB(@NativeType("GLuint") int count, @NativeType("GLenum *") @Nullable int [] sources, @NativeType("GLenum *") @Nullable int [] types, @NativeType("GLuint *") @Nullable int [] ids, @NativeType("GLenum *") @Nullable int [] severities, @NativeType("GLsizei *") @Nullable int [] lengths, @NativeType("GLchar *") @Nullable ByteBuffer messageLog) {
