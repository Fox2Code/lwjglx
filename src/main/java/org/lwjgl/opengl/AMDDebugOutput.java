...
public class AMDDebugOutput {
    ...
    public static void glDebugMessageCallbackAMD(AMDDebugOutputCallback callback) {
        glDebugMessageCallbackAMD(callback.lwjglxGetLWJGL3Callback(), NULL);
    }
    // -- End LWJGL2 part --
    ...
    public static void glDebugMessageEnableAMD(@NativeType("GLenum") int category, @NativeType("GLenum") int severity, @NativeType("GLuint const *") @Nullable int [] ids, @NativeType("GLboolean") boolean enabled) {
    ...
    @NativeType("GLuint")
    public static int glGetDebugMessageLogAMD(@NativeType("GLuint") int count, @NativeType("GLenum *") @Nullable int [] categories, @NativeType("GLenum *") @Nullable int [] severities, @NativeType("GLuint *") @Nullable int [] ids, @NativeType("GLsizei *") @Nullable int [] lengths, @NativeType("GLchar *") @Nullable ByteBuffer messageLog) {
